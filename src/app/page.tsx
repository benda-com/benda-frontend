...
export default function Home() {
  return (
    <>
      <Nav />
      <main className="flex flex-col space-y-20 overflow-hidden px-1 py-10">
        <HeroBanner />
        ...
        <section className="flex flex-col space-y-10  md:items-center">
          ...
          <Faq
            question={
              "What happens if my health data shows an abnormal reading?"
            }
            answer={
        ...
        <section className="flex flex-col">
          ...
          <div className="flex flex-col justify-evenly  md:flex-row">
            <Link href="#">
              <Image
                src="https://benda-images.s3.eu-north-1.amazonaws.com/ey.png"
                alt="EY"
                width={200}
                height={200}
              />
            ...
            <Link href="#">
              <Image
                src="https://benda-images.s3.eu-north-1.amazonaws.com/orange.png"
                alt="EY"
                width={500}
                height={500}
              />
            ...
            <Link href="#">
              <Image
                className=" pt-11"
                src="https://benda-images.s3.eu-north-1.amazonaws.com/aws.png"
                alt="EY"
                width={200}
                height={200}
              />
